...
class BillResource extends Resource
{
    ...
    protected static ?string $recordTitleAttribute = 'Bollette';

    //SOVRASCRIVO I LABEL AUTOMATICI DI FILAMENT
    protected static ?string $navigationLabel = 'Bollette';
    protected static ?string $modelLabel = 'Bolletta';
    protected static ?string $pluralModelLabel = 'Bollette';
